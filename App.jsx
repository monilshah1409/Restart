...
export default function App() {
  ...
  return (
    ...
    >
      ...
      >
        <div className="container mx-auto px-4 py-4 flex justify-between items-center">
          <div className="flex items-center space-x-2 group">
            {/* Remove this SVG icon */}
            <span className="text-xl font-bold">Restart</span>
          </div>

          {/* Desktop Nav */}
          <nav className="hidden md:flex space-x-8">
            {["home", "services", "about", "testimonials", "events", "contact", "intake"].map((tab) => (
              <button
                key={tab}
      ...
      <div
        className={`fixed top-0 right-0 h-full w-64 p-6 z-50 transform transition-transform duration-300 ease-in-out bg-white dark:bg-slate-800 shadow-lg ${
          ...
          {["facebook", "twitter", "instagram", "linkedin"].map((social) => (
            ...
            >
              <svg
                ...
                className="w-5 h-5"
              >
                <path d="M12 0c-6.627 0-12 5.373-12 12s5.373 12 12 12 12-5.373 12-12-5.373-12-12-12zm3 8h-1.35c-.538 0-.65.221-.65.778v1.222h2l-.209 2h-1.791v7h-3v-7h-2v-2h2v-2.305c0-1.791.91-2.695 3.029-2.695h1.971v3z" />
              </svg>
            </a>
          ))}
        </div>
            ...
            <div className="container mx-auto px-4 flex flex-col-reverse md:flex-row items-center">
              ...
              <div className="md:w-1/2 mb-10 md:mb-0 order-2 md:order-1 animate-slideLeft">
                ...
                <p className="text-lg mb-8 max-w-lg">
                  At Restart, we offer personalized mental health care with experienced professionals who understand your journey.
                </p>
              ...
              <div className="md:w-1/2 flex justify-center order-1 md:order-2 animate-slideRight">
                <img
                  ...
                  className="rounded-lg shadow-xl w-full max-w-md transform transition-transform hover:scale-105 duration-300"
                />
              </div>
            </div>
          </section>
          ...
          <section className="py-16 container mx-auto px-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
              ...
              <div className="animate-slideRight">
                ...
                <p className="mb-4">
                  Restart was founded on the belief that everyone deserves access to quality mental healthcare.
                  Our team consists of licensed therapists, psychologists, and counselors with diverse expertise in various therapeutic approaches.
                </p>
                <p>
                  Whether you're dealing with anxiety, depression, relationship issues, or simply looking to improve your well-being,
                  we're committed to providing compassionate, evidence-based care in a safe and supportive environment.
                </p>
              </div>
            </div>
          </section>
